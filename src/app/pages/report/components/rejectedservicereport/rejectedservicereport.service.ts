...
export class RejectedServiceReportService {
    ...
    getRejectedServiceReport(kode_dealer, tgl_awal, tgl_akhir) {
        ...
        if (kode_dealer == '') {
            return this.http.get<any>(this.global.GlobalUrl + '/getRejectedServiceReportService/' + tgl_awal + '/' + tgl_akhir, {headers});
        } else {
            return this.http.get<any>(this.global.GlobalUrl + '/getRejectedServiceReportService/' + kode_dealer + '/' + tgl_awal + '/' + tgl_akhir, {headers});
        }
    }

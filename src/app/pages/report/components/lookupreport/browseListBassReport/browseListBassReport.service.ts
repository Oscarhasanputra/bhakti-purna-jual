...
export class BrowseListBassReportService {
    ...
    getReportServiceList(kode_dealer,tgl_awal,tgl_akhir,status){
        ...
        return this.http.get(this.global.GlobalUrl + '/reportServiceList/' + kode_dealer + '/' + tgl_awal + '/' + tgl_akhir + '/' + status, {headers});
    }
    ...
    getReportServiceListALL(kode_dealer,tgl_awal,tgl_akhir){
        ...
        return this.http.get(this.global.GlobalUrl + '/reportServiceList/' + kode_dealer + '/' + tgl_awal + '/' + tgl_akhir, {headers});
    }
